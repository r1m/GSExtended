...
/*global AutoCompletePopup, Notification, FileReader, GS, GSXmodules, GSXUtil, GSXmagnifyingSettings, jqueryUtilInit, console, Linkified, $, _ */
...
var GSX = (function () {
    ...
    return {
        ...
        init: function () {
            ...
            GSXmodules.forEach(function (m) {
                console.log('Init module', m.name);
                m.init();
            });
